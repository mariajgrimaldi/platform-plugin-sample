...
"""
platform-plugin-sample documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-sample',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/platform-plugin-sample",
...
#
# html_title = 'platform-plugin-sample v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Where I implement extensions for edx-platforms just because.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_sample'),
                os.path.join(root_path, 'platform_plugin_sample/migrations')])
